...
function ExamPage() {
  ...
  const { addToLeaderboard } = useLeaderboard(); // Use the hook here
  ...
  useEffect(() => {
    ...
    const handleFullscreenChange = () => {
      if (!document.fullscreenElement) {
        ...
        // Check if warning count exceeds 2
        if (newWarningCount >= 3) {
          addToLeaderboard(id, name, newWarningCount, true); // Add to leaderboard with termination
  ...
  }, [warningCount, navigate, addToLeaderboard, id, name]); // Add dependencies here

  const handleGoBack = () => {
    addToLeaderboard(id, name, warningCount, false); // Add to leaderboard with no termination
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          <h2 style={styles.heading}>Periodic Test - {testDetails?.subjectName}</h2>
      ...
      <div style={styles.content}>
        <div style={styles.leftSection}>
          <div style={styles.webcamContainer}>
            <img src="http://localhost:5000/video_feed" alt="Video Feed" style={styles.webcam} />
          </div>
        ...
        <div style={styles.rightSection}>
          ...
          {testDetails?.subjectName === studentSubject && (
            <div>
              <h4>Test Link:</h4>
